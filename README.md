...
## ✍🏻 규칙
> ### Git 관리
> **1. 로컬에서 원격의 dev 브랜치 불러오기(fetch)** <br>
> **2. 로컬에서 개발 기능 단위로 새로운 브랜치 생성 후 개발** <br>
> **3. 테스트 후 새로운 브랜치를 원격 저장소로 push** <br>
> **4. 원격에 생성된 새 브랜치를 dev 브랜치로 pull request** <br>
> **5. dev에서 추가적인 테스트 및 코드리뷰 후 merge 허용** <br>
> **6. dev를 main으로 merge** <br>
> **7. main 브랜치에 대한 CI/CD 수행**
