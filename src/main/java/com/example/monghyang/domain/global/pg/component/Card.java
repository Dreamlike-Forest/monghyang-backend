...
import com.example.monghyang.domain.global.pg.status.AcquireStatus;
import com.example.monghyang.domain.global.pg.type.CardType;
import com.example.monghyang.domain.global.pg.type.InterestPayer;
import com.example.monghyang.domain.global.pg.type.OwnerType;
...
@Setter
public class Card {
    private Integer amount;                 // 카드사에 결제 요청한 금액(즉시 할인 금액 포함)
