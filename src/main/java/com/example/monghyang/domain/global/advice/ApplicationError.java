...
public enum ApplicationError {
    ...
    AUTH_INFO_NOT_FOUND(HttpStatus.NOT_FOUND, "인증 정보가 존재하지 않습니다."),
    ...
    CONCURRENT_CONNECTION(HttpStatus.CONFLICT, "다른 곳에서 새로 접속하였습니다."),
    ...
    LOGIN_RESPONSE_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "로그인 http body 생성 중 에러가 발생했습니다.");
