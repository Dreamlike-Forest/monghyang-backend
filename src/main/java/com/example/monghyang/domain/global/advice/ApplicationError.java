...
public enum ApplicationError {
    ...
    ORDER_CANNOT_CANCEL(HttpStatus.BAD_REQUEST, "배송 시작 전인 상품만 취소할 수 있습니다."),
    ...
    JOY_COUNT_OVER(HttpStatus.BAD_REQUEST, "예약 가능 인원수를 초과하였습니다."),
    ...
    IMAGE_REMOVE_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "이미지 제거 중 서버에서 에러가 발생했습니다."),
    ...
    IMAGE_COUNT_INVALID(HttpStatus.BAD_REQUEST, "이미지는 최대 5개 업로드할 수 있습니다."),
    ...
    NEW_PASSWORD_NULL(HttpStatus.BAD_REQUEST, "새 비밀번호를 입력해주세요."),
    NOT_MATCH_CUR_PASSWORD(HttpStatus.UNAUTHORIZED, "기존 비밀번호가 일치하지 않습니다."),
