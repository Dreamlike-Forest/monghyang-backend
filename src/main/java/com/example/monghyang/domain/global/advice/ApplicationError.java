...
public enum ApplicationError {
    ...
    JOY_ORDER_DELETE_ERROR(HttpStatus.BAD_REQUEST, "체험 종료 이후부터 예약 내역을 삭제할 수 있습니다.", ErrorType.BUSINESS, LogLevel.INFO, false),
    ...
    ORDER_CANNOT_CANCEL(HttpStatus.BAD_REQUEST, "배송 시작 전인 상품만 취소할 수 있습니다.", ErrorType.BUSINESS, LogLevel.INFO, false),
    ...
    ADD_CLOSED_DATE_DUPLICATE(HttpStatus.CONFLICT, "이미 휴무 처리된 날짜입니다.", ErrorType.BUSINESS, LogLevel.INFO, false),
    DELETE_CLOSED_DATE_DUPLICATE(HttpStatus.CONFLICT, "휴무일이 아닌 날짜입니다.", ErrorType.BUSINESS, LogLevel.INFO, false),
    ...
    TOKEN_EXPIRED(HttpStatus.UNAUTHORIZED, "토큰이 만료되었습니다. 다시 로그인 해주세요.", ErrorType.SECURITY, LogLevel.INFO, true),
    ...
    IMAGE_FORMAT_ERROR(HttpStatus.BAD_REQUEST, "이미지 형식이 잘못되었습니다.", ErrorType.BUSINESS, LogLevel.INFO, true),
    IMAGE_SIZE_OVER(HttpStatus.BAD_REQUEST, "10MB가 넘는 이미지를 업로드할 수 없습니다.", ErrorType.BUSINESS, LogLevel.INFO, true),
    IMAGE_SIZE_ERROR(HttpStatus.BAD_REQUEST, "잘못된 크기의 이미지입니다.", ErrorType.BUSINESS, LogLevel.INFO, true),
    IMAGE_SEQ_NULL(HttpStatus.BAD_REQUEST, "이미지의 순서 정보(seq)가 누락되었습니다.", ErrorType.BUSINESS, LogLevel.INFO, true),
    IMAGE_SEQ_INVALID(HttpStatus.BAD_REQUEST, "이미지의 순서 정보가 올바르지 않습니다. 수정사항을 롤백합니다.", ErrorType.BUSINESS, LogLevel.INFO, false),
    IMAGE_COUNT_INVALID(HttpStatus.BAD_REQUEST, "이미지는 최대 5개 업로드할 수 있습니다.", ErrorType.BUSINESS, LogLevel.INFO, true),
    ...
    DTO_NULL_ERROR(HttpStatus.BAD_REQUEST, "DTO가 null입니다.", ErrorType.BUSINESS, LogLevel.INFO, false),
