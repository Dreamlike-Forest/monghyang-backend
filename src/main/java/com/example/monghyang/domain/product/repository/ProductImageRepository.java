...
public interface ProductImageRepository extends JpaRepository<ProductImage, Long> {
    ...
    @Modifying
    @Query("update ProductImage pi set pi.seq = pi.seq * -1 where pi.product.id = :productId and pi.seq < 0")
    void updateImageSeqToPositive(@Param("productId") Long productId);
}
